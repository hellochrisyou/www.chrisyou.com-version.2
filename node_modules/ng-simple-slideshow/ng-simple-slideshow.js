...
class SwipeService {
    ...
    swipe(e, when, debug) {
        ...
        if (when === 'start') {
            ...
            const /** @type {?} */ direction = [coord[0] - this.swipeCoord[0], coord[1] - this.swipeCoord[1]];
            const /** @type {?} */ duration = time - this.swipeTime;
...
class SlideshowComponent {
     ...
     * @param {?} document
     */
    constructor(swipeService, renderer, transferState, sanitizer, platform_id, document) {
    ...
    onSwipe(e, when) {
        if (this.disableSwiping === true)
            return;
        const /** @type {?} */ indexDirection = this.swipeService.swipe(e, when, this.debug === true);
    ...
    loadFirstSlide() {
        ...
        if (isPlatformServer(this.platform_id)) {
            ...
            const /** @type {?} */ firstSlideFromTransferState = this.transferState.get(FIRST_SLIDE_KEY, /** @type {?} */ (null));
