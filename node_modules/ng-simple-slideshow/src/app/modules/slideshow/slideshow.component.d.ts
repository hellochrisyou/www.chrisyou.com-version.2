...
export declare class SlideshowComponent implements DoCheck {
    ...
    constructor(swipeService: SwipeService, renderer: Renderer2, transferState: TransferState, sanitizer: DomSanitizer, platform_id: any, document: any);
    ngDoCheck(): void;
    /**
