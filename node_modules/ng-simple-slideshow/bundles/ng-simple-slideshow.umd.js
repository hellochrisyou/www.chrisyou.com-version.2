(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('util'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'util', '@angular/platform-browser'], factory) :
	(factory((global['ng-simple-slideshow'] = {}),global.ng.core,global.ng.common,global.util,global.ng.platformBrowser));
}(this, (function (exports,core,common,util,platformBrowser) { 'use strict';
...
var SlideshowComponent = /** @class */ (function () {
    ...
    SlideshowComponent.prototype.onClick = function (e) {
        ...
        if (currentSlide && !util.isNullOrUndefined(currentSlide.image.clickAction)) {
            currentSlide.image.clickAction();
        }
        else if (currentSlide && !util.isNullOrUndefined(currentSlide.image.href)) {
    ...
    SlideshowComponent.prototype.setSlides = function () {
        if (!util.isNullOrUndefined(this.imageUrls)) {
            if (this.debug === true)
    ...
    SlideshowComponent.prototype.handleAutoPlay = function (stopAutoPlay) {
        ...
        if (stopAutoPlay === true || this.autoPlay === false) {
            ...
            if (!util.isNullOrUndefined(this.autoplayIntervalId))
                clearInterval(this.autoplayIntervalId);
        }
        else if (util.isNullOrUndefined(this.autoplayIntervalId)) {
            if (this.debug === true)
    ...
    SlideshowComponent.prototype.setStyles = function () {
        ...
        if (!util.isNullOrUndefined(this.minHeight))
            this.renderer.setStyle(this.container.nativeElement, 'min-height', this.minHeight);
        if (!util.isNullOrUndefined(this.arrowSize)) {
...
SlideshowComponent.propDecorators = {
    ...
    'onSlideLeft': [{ type: core.Output, args: ['onSlideLeft',] },],
    'onSlideRight': [{ type: core.Output, args: ['onSlideRight',] },],
    'onSwipeLeft': [{ type: core.Output, args: ['onSwipeLeft',] },],
    'onSwipeRight': [{ type: core.Output, args: ['onSwipeRight',] },],
